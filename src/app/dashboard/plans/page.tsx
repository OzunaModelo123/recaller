...
export default async function PlansListPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-xl font-semibold tracking-tight text-stone-900">Plans</h1>
      ...
      {!plans?.length ? (
        <div className="rounded-2xl border border-dashed border-stone-200 bg-stone-50/50 py-16 text-center text-sm text-stone-500">
          No plans yet. Open a ready content item and choose{" "}
          <span className="font-medium text-stone-700">Generate plan</span>.
        </div>
      ) : (
